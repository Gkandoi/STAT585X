...
GOexplore provides a very interactive interface for people with little to no programming background to browse through the complex gene annotations and intuitively visualize the distribution of genes and GO terms and filter these based on their aspect or evidence code.